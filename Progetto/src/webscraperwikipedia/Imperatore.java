...
/**
 * This class inherts all the methods and attributes from Person class
 * and his used when a Person object is found out to be an Emperor, so
 * an attribute that shows how long his reign lasted is necessary.
...
public class Imperatore extends Person{
	 ...
	 * @return	mandate, how long his reign lasted
	 */
