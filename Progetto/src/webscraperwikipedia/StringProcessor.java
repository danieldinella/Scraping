...
public class StringProcessor {
	...
	/** 
	 * (Person as root) Starting from an initial number of tabs of 0 and the Person object called root, 
	...
	/** 
	 * (Imperatore as root) Starting from an initial number of tabs of 0 and the Person object 
	 * called root, the method performs a pre-order visit using recursive calls using his 
	 * children and the number of tabs plus 1.
	 * Each call assembles a line of the string codifica following the his syntax using
	 * controls for each Person object's attribute
